<template>
  <v-sheet class="eighthD d-flex flex-column align-center justify-center">
    <!-- Naslov -->
    <div class="text-center mb-10">
      <h2><span style="color:#00a9c0; font-weight: 700; font-family: 'Cinzel', serif; font-size: 2rem; color: #af9458;">{{t('title_part1')}}</span><br /><span style="font-family: 'Great Vibes', cursive; color: #222; font-size: 2rem;">{{ t('title_part2') }}</span></h2>
    ...
    <div class="contact-cards d-flex justify-center mb-10" style="gap: 24px; flex-wrap: wrap;">
      <v-card class="contact-card" elevation="2" outlined>
        <v-card-text class="text-center">
          <v-icon size="28" color="#af9458">mdi-map-marker</v-icon>
      ...
      <v-card class="contact-card" elevation="2" outlined>
        <v-card-text class="text-center">
          <v-icon size="28" color="#af9458">mdi-email</v-icon>
      ...
      <v-card class="contact-card" elevation="2" outlined>
        <v-card-text class="text-center">
          <v-icon size="28" color="#af9458">mdi-phone</v-icon>
    ...
    <!-- Forma za poruku -->
    <v-card class="message-card" elevation="2" outlined>
      <v-card-text>
